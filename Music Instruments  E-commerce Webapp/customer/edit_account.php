<?php 
	...
	$customer_loc = $row_customer['customer_loc'];
...
<form action="" method="post" enctype="multipart/form-data"> <!----form start ---->
	...
	<div class="form-group"><!----form group starts---->
		...
		<input type="text" name="c_location" class="form-control" required value="<?php echo $customer_loc; ?>">
	</div><!----form group ends ---->
...
$update_customer = "update customers set customer_name='$c_name',customer_email='$c_email',customer_loc='$c_location',customer_contact='$c_contact',customer_image='$c_image' where customer_id='$update_id'";
